...
'''
** This is the same as the train.py script except this one is NOT optimized to be run on multiple GPUs **
'''
...
def train(args):
    ...
    for epoch_itr in tqdm(range(args.max_epoch), desc='Epoch'):
        ...
        '''
        for itr, data in tqdm(enumerate(train_dataloader), desc='Training loop'):
        ...
        for itr, data in tqdm(enumerate(valid_dataloader), desc='Validation loop'):
